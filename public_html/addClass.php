...
//Skeleton for Create Class Form
...
print "<input type = 'submit' name = 'createClass' value='Create It'>";
//Make a call to createClass function within ClassArray
/* $create->createClass(classId, className, classCode, classNum, instructor, meetingTime); */
